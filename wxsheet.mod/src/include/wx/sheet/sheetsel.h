...
public:
    ...
    wxSheetCoords& ShiftRow( int row )         { m_row += row; return *this; }
    wxSheetCoords& ShiftCol( int col )         { m_col += col; return *this; }
    wxSheetCoords& Shift( int rows, int cols ) { m_row += rows; m_col += cols; return *this; }
...
public:
    ...
    wxSheetBlock( const wxSheetCoords& topLeft, int height, int width )
...
public :
    ...
    wxSheetSelectionIter_Type GetIterType() const { return m_type; }
