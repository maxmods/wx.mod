...
public:
    ...
    // validation
    bool HasForegroundColour() const;
    ...
    wxSheetCellRenderer GetRenderer(wxSheet* sheet, const wxSheetCoords& coords) const;
    wxSheetCellEditor GetEditor(wxSheet* sheet, const wxSheetCoords& coords) const;
...
// ----------------------------------------------------------------------------
class WXDLLIMPEXP_SHEET wxSheetCellAttrProvider : public wxObject
{
public:
    wxSheetCellAttrProvider() {}
    virtual ~wxSheetCellAttrProvider() {}

    // Make a full copy of the other provider
    void Copy( const wxSheetCellAttrProvider& other );

    // Clear the attributes for the different types, takes ORed values of
    //   see wxSheetUpdate_Type::wxSHEET_Update[GridCell][Row/ColLabel]Attrs
    void Clear( int update );
    ...
    // modify these as a last resort, please use methods in wxSheet
    wxPairArraySheetCoordsCellAttr& GetGridCellAttrs() { return m_cellAttrs; }
    wxPairArrayIntSheetCellAttr&    GetRowAttrs()      { return m_rowAttrs; }
    wxPairArrayIntSheetCellAttr&    GetColAttrs()      { return m_colAttrs; }
    wxPairArrayIntSheetCellAttr&    GetRowLabelAttrs() { return m_rowLabelAttrs; }
    wxPairArrayIntSheetCellAttr&    GetColLabelAttrs() { return m_colLabelAttrs; }
...
protected:
    ...
    DECLARE_ABSTRACT_CLASS(wxSheetCellAttrProvider)
};
