...
'	End Function
	...
	Method CreateCheckListbox(flags:Int = 0)
		...
		Local aszChoices:String[] = ["Zeroth", "First", "Second", "Third", ..
			"Fourth", "Fifth", "Sixth", "Seventh", "Eighth", "Nineth"]
			
		listBox = wxCheckListBox.CreateCheckListBox(panel, Control_Listbox, aszChoices, 10, 10, 350, 100, flags)
